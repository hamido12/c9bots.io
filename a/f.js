...
console.log("Started bitch clan bots!!");
console.log("by david: visit YT channel agar.io bitch clan!");
console.log("VISIT YT CHANNEL: BITCH CLAN YT!");
console.log("VISIT CHANNEL: BITCH CLAN YT!");
});
/*
