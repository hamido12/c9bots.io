...
config.client_uuid = "O1ULDBIHcGdZMjP"; // after you install the userscript press F12 and search for a debug msg on the console
...
config.maxBots = 20000;

config.useRandomSkinName = true; // Set to true to use random name
config.useStaticName = ""; // If above is false, us this skin name
